...
const fallbackQuizData = [
  ...
  },
  {
    "id": 24,
    "materie": "Algoritmi și structuri de date",
    "enunt": "Pentru 0 <= i, j < n definim relația bunic(i, j) dacă A[j] reține părintele părintelui nodului din A[i]. Formula ce definește relația bunic(i, j) în un min-heap binar este:",
    "cod_sursa": "",
    "variante": {
  ...
  },
  {
    "id": 25,
    "materie": "Algoritmi și structuri de date",
    "enunt": "Numărul maxim de noduri în un min-heap binar cu adâncimea h este:",
    "cod_sursa": "",
    "variante": {
      "a": "2^(h+1) - 1",
      "b": "2^h",
  ...
  },
  {
    "id": 26,
    "materie": "Algoritmi și structuri de date",
    "enunt": "(1) Dacă A este un min-heap binar atunci A este sortat în ordinea crescătoare a cheilor din noduri? (2) Dacă A este sortat în ordinea crescătoare a cheilor din noduri atunci A este un min-heap binar?",
    "cod_sursa": "",
    "variante": {
      "a": "(1) fals (2) adevărat",
      "b": "(1) fals (2) fals",
  ...
  },
  {
    "id": 27,
    "materie": "Algoritmi și structuri de date",
    "enunt": "Timpul de execuție a operației de ștergere a nodului cu cheie minimă din un min-heap binar cu n noduri este:",
    "cod_sursa": "",
    "variante": {
      "a": "O(1)",
      "b": "O(log n)",
  ...
  },
  {
    "id": 32,
    "materie": "Teoria grafurilor și combinatorică",
    "enunt": "Protocolul IPv4 prevede că o adresă internet este un șir de 32 biți. Sunt 3 tipuri de adrese internet: Clasa A (începe cu 0), Clasa B (începe cu 10), Clasa C (începe cu 110). Câte adrese IPv4 diferite sunt disponibile pentru conexiunile de rețea din internet?",
    "cod_sursa": "",
    "variante": {
      "a": "2^29 * 2^30 * 2^31",
      "b": "2^31",
  ...
  },
  {
    "id": 43,
    "materie": "Teoria grafurilor și combinatorică",
    "enunt": "Fie G un graf simplu neorientat cu n noduri numerotate de la 1 la n, și A_G matricea lui de adiacență. Numărul de grafuri neorientate simple cu n noduri numerotate de la 1 la n este:",
    "cod_sursa": "",
    "variante": {
      "a": "2^{n(n−1)/2}",
      "b": "2^n",
  ...
  },
  {
    "id": 44,
    "materie": "Teoria grafurilor și combinatorică",
    "enunt": "Fie M_n mulțimea matricilor n x n cu elemente 0 sau 1. Definim: A ⊕ B = C dacă C[i][j] = max(A[i][j], B[i][j]) și A ⊙_k B = D dacă D[i][j] = A[i][k] * B[k][j]. Complexitatea temporală a calculului matricii B în algoritmul următor este:",
    "cod_sursa": "B = A_G ⊕ I_n;\nfor k := 1 to p do\n  C = B ⊕ (B ⊙_k B);\n  B = C;",
    "variante": {
      "a": "Θ(p * n^2)",
      "b": "Θ(p * n)",
  ...
  },
  {
    "id": 45,
    "materie": "Teoria grafurilor și combinatorică",
    "enunt": "Pentru algoritmul de la problema anterioară, care din afirmațiile următoare este adevărată când B[i][j] = 1 la final?",
    "cod_sursa": "",
    "variante": {
  ...
  },
  {
    ...
    "enunt": "Considerați, în logica predicatelor, limbajul care conține următoarele simboluri: variabile, pentru care se folosesc litere mici; simboluri funcționale F : + binar, infix, − unar, prefix, ∗ binar, infix; simboluri predicative P: =, <, ≤ toate binare, infix; simboluri pentru constante C: 0, 1. Care din următoarele sunt termeni peste acest limbaj?",
    "cod_sursa": "",
    "variante": {
      "a": "(0 ∗ x)− 1",
      "b": "1 + (z ∗ x) < 0",
  ...
  },
  {
    "id": 50,
    "materie": "Logică computațională",
    "enunt": "Formula P ⇔ Q este (a) logic echivalentă cu conjuncția formulelor de mai joș (b) o consecință logică a formulelor de mai joș (c) logic echivalentă cu disjuncția formulelor de mai joș aceste formule fiind: Q ⇒ R, R ⇒ (P ∧ Q), P ⇒ (Q ∨ R).",
    "cod_sursa": "",
    "variante": {
      "a": "logic echivalentă cu conjuncția formulelor",
      "b": "o consecință logică a formulelor",
      "c": "logic echivalentă cu disjuncția formulelor"
    },
    "raspuns_corect": [
      "b"
    ],
  ...
  },
  {
    "id": 72,
    "materie": "Limbaje formale și teoria automatelor",
    "enunt": "Fie L limbajul generat de gramatica G = (VN, VT, S, P) unde VN = {S, A,B,C,X,Y,Z}, VT = {a, b, c}, și P = { S → λ|AX|BY|CZ, X → λ|BY|CZ, Y → λ|AX|CZ, Z → λ|AX|BY, A → a, B → b, C → c}. Alegeți răspunsurile corecte.",
    "cod_sursa": "",
    "variante": {
  ...
  },
  {
    "id": 73,
    "materie": "Limbaje formale și teoria automatelor",
    "enunt": "Fie L limbajul generat de gramatica de la exercițiul anterior. Care din afirmațiile următoare este adevărată?",
    "cod_sursa": "",
    "variante": {
  ...
  },
  {
    "id": 74,
    "materie": "Limbaje formale și teoria automatelor",
    "enunt": "Fie L limbajul generat de gramatica de la exercițiul anterior. Fie s_n numărul șirurilor din L cu lungimea n. Pentru orice n > 1 are loc relația de recurență:",
    "cod_sursa": "",
    "variante": {
      "a": "sn = 2 · sn−1",
      "b": "sn = 3 · sn−1",
  ...
  },
  {
    "id": 75,
    "materie": "Limbaje formale și teoria automatelor",
    "enunt": "Fie L limbajul generat de gramatica de la exercițiul anterior. Câte șiruri cu lungimea 4 conține L?",
    "cod_sursa": "",
    "variante": {
      "a": "16",
      "b": "24",
  ...
  },
  {
    ...
    "materie": "Limbaje de programare și inginerie software",
    "subcategorie": "Limbajul Python",
    "enunt": "Când este execută clauzafinallydintr-un bloctry: except:",
    "cod_sursa": "",
    "variante": {
  ...
  },
  {
    ...
    "enunt": "Fie următoarea secvență de cod:",
    "cod_sursa": "#define swap(a,b) {int aux; aux=a; a=b; b=aux;}\nfloat x=10.5, y=3.75;\nîn urma apeluluiswap(x, y);valorile variabilelorx, respectivyvor fi:",
    "variante": {
      "a": "x=3.75, y=10.5;",
      "b": "x=3.0, y=10.5;",
      "c": "x=3.75, y=10.0;",
  ...
  },
  {
    ...
    "variante": {
      "a": "clasaRectanglenu poate fi\ninstanțiață deoarece metoda\naddControlPoint()nu este im-\nplementată",
      "b": "clasaRectanglenu poate fi\ninstanțiață deoarece este clasă\nabstractă",
  ...
  },
  {
    ...
    "cod_sursa": "void main(String [] arg) {\nA a = new A();\n}\n}\nCare din variantele de mai jos instantiază și lansează în execuție un fir de execuție de tipul clasei\nA?",
    "variante": {
      "a": "(new Thread()).start()",
  ...
  },
  {
    ...
    "materie": "Limbaje de programare și inginerie software",
    "subcategorie": "Limbajul Java",
    "enunt": "Considerand următoarea secvență de cod, stabiliți care este ordinea execuției (in ipoteza că o\nclasă are un constructor, o metodă, un bloc static și un bloc de instanță):\npublic class A {\npublic A() {\nSystem.out.print(\"constructor; \");\n}\npublic void method() {\nSystem.out.print(\"method; \");\n}\n{\nSystem.out.print(\"instance block; \");\n}\nstatic {\nSystem.out.print(\"static block; \");\n}\npublic static",
    "cod_sursa": "void main(String[] args) {\nA a = new A();\na.method();\n}\n}",
    "variante": {
  ...
  },
  {
    ...
    "cod_sursa": "",
    "variante": {
      "a": "Un obiect de tipComputerScienceconține o colecție de obiecte de tipStudent",
      "b": "ClasaQuestionnaireare un atribut public de tipString",
      "c": "ClasaComputerScienceare operat ,ia publicăaddStudent(s:Student)",
      "d": "ClasaComputerScienceare operat ,ia privatăsetSchedule(s:String)",
      "e": "ClasaTutoreste superclasă pentru clasaMasterand",
      "f": "ClasaComputerSciencedefines ,te o compoziție de obiecte de tipQuestionnaire.\n(g) Între clasaComputerSciences ,i clasaTutorexistă o asociere unidirecțională.\n(h) ClasaComputerSciencemos ,tenește interfațaSpecialization.\n(i) ClasaTutordefines ,te un agregat de obiecte de tipMasterand."
    },
    "raspuns_corect": [
      "a",
      "c",
    ...
    "imagine": "images/diagram_122.png"
  },
  {
    "id": 123,
    "materie": "Limbaje de programare și inginerie software",
  ...
  },
  {
    ...
    "materie": "Limbaje de programare și inginerie software",
    "subcategorie": "Proiectarea aplicațiilor software",
    "enunt": "Fie următoarea diagramă de secvențe.\nCe operații ale claseiControlerInscriererezultă din aceasta?",
    "cod_sursa": "",
    "variante": {
      "a": "getCursuri()",
      "b": "display(listaCursuriOferite)",
      "c": "inscriere(studenț listaCursuriSelectate)",
    ...
    "imagine": "images/diagram_127.png"
  },
  {
    "id": 128,
    "materie": "Limbaje de programare și inginerie software",
  ...
  },
  {
    ...
    "imagine": "images/diagram_129.png"
  },
  {
    "id": 130,
    "materie": "Limbaje de programare și inginerie software",
  ...
  },
  {
    ...
    "enunt": "Se consideră tabela R(A) conținând înregistrările {(1), (2)} și tranzacțiile\n(T1) UPDATE R SET A = A*2\n(T2) SELECT AVG(A) FROM R; SELECT MAX(A) FROM R\nDacă tranzacția T2 se execută folosind nivelul de izolarerepeatable read, care dintre următoarele\nafirmații este adevărată",
    "cod_sursa": "",
    "variante": {
  ...
  },
  {
    ...
    "cod_sursa": "",
    "variante": {
      "a": "π sN ame(Student ▷ ◁\n(πsID (Student)−(π sID (σmajor= ′CS ′Apply)∪π sID (σmajor= ′P H′Apply))))",
      "b": "π sN ame(Student ▷ ◁\n(πsID Student−π sID (σmajor= ′CS ′ ∨major= ′P H′Apply)))",
      "c": "π sN ame(πsID,sN ameStudent−\nπsID,sN ame(Student ▷ ◁ πsID (σmajor= ′CS ′ ∨major= ′P H′Apply)))",
      "d": "π sN ameStudent−\nπsN ame(Student ▷ ◁ πsID (σmajor= ′CS ′ ∨major= ′P H′Apply))"
    },
    "raspuns_corect": [
      "d"
    ],
  ...
  },
  {
    ...
    "imagine": "images/diagram_138.png"
  },
  {
    "id": 139,
    "materie": "Limbaje de programare și inginerie software",
  ...
  },
  {
    ...
    "materie": "Limbaje de programare și inginerie software",
    "subcategorie": "Baze de date",
    "enunt": "Se dorește afișarea coloanelor FIRST_NAME și SALARY aferente angajaților din tabelul EM-\nPLOYEEScareauacelas ,ișef(MANAGER_ID)cualangajatuluiidentificatprinEMPLOYEE_ID\n= 101 și care au un salariu mai mare sau egal cu al aceluiași angajat identificat prin EM-\nPLOYEE_ID = 101. Care dintre interogările următoare vor afișa rezultatul dorit?",
    "cod_sursa": "",
    "variante": {
  ...
  },
  {
    ...
    "materie": "Sisteme de calcul",
    "subcategorie": "Arhitectura calculatoarelor",
    "enunt": "Care este valoarea stocată la adresacdupă executarea următoarei secvențe de cod?\nx DAT A4B\ny DAT A F\nc DAT A0\nstart LDA x\nCM P y\nJ GE adr1\nADD y\nST A c\nJ M P adr2\nadr1SU B y\nST A c\nadr2ST OP\nEN D start",
    "cod_sursa": "",
    "variante": {
      "a": "3C 16",
      "b": "20 8",
  ...
  },
  {
    ...
    "materie": "Sisteme de calcul",
    "subcategorie": "Sisteme de operare",
    "enunt": "Se consideră 5 segmente de memorie(A, B, C, D, E)cu mărimile2k,6k,4k,3k,4kși o memorie\ntotală de16k. În memorie se încarcă în ordine segmenteleA,B,C,D. Care dintre aceste segmente\nurmează să fie evacuat pentru a putea permite încărcarea ulterioară a segmentuluiE?",
    "cod_sursa": "",
    "variante": {
      "a": "A",
      "b": "B",
  ...
  },
  {
    ...
    "materie": "Sisteme de calcul",
    "subcategorie": "Sisteme de operare",
    "enunt": "Se consideră 3 fire de control a execuției care partajează variabileleAșiB. Accesul către cele\ndouă variabile este nerestricționaț iar operațiile realizate sunț în fiecare fir de control a execuției,\nurmătoareleA=A+B, B=A−B, A=A−B. Precizați care dintre următoarele valori sunt\nposibile la sfârșitul execuției celor trei fire de control, atunci cândA= 5, B= 7",
    "cod_sursa": "",
    "variante": {
      "a": "A= 5, B= 7",
      "b": "A= 7, B= 5",
  ...
  },
  {
    ...
    "materie": "Sisteme de calcul",
    "subcategorie": "Sisteme de operare",
    "enunt": "Se consideră o situație simplă cu 6 procese și un singur tip de resurse. Starea sistemului este\ndescrisă prinAre= (4,2,0,5,1,4), M ax= (8,10,10,25,25,30), Disponibil=D. Determinați\nvaloarea minimăDpentru care starea este sigură și permite apoi alocarea a 3 resurse suplimentare\ncătre procesul al doilea.",
    "cod_sursa": "",
    "variante": {
      "a": "D= 12",
      "b": "D= 14",
  ...
  },
  {
    ...
    "materie": "Sisteme de calcul",
    "subcategorie": "Sisteme de operare",
    "enunt": "Se consideră o situație simplă cu 6 procese și un singur tip de resurse. Starea sistemului este\ndescrisă prinAre= (4,2,0,5,1,4), M ax= (14,6,8,29,27,24), Disponibil=D. Determinați\nvaloarea minimăDpentru care starea este sigură și permite apoi alocarea a 3 resurse suplimentare\ncătre procesul al treilea.",
    "cod_sursa": "",
    "variante": {
      "a": "D= 11",
      "b": "D= 13",
  ...
  },
  {
    ...
    "materie": "Sisteme de calcul",
    "subcategorie": "Sisteme de operare",
    "enunt": "Se consideră un set de patru procese, cu timpi estimați de execuție2,3,4s ,i5. Fiecare dintre\nprocese are două execuții succesive separate printr-un ciclu de operații de intrare/ieșire. Planifi-\ncarea inițială a proceselor este FIFO, după momentul15, algoritmul de planificare este modificat\n\nla SJF. Știind că timpii de răspunș după cea de-a doua execuție, raportați la momentul0, sunt\n22,25,20,30, și că timpii asociați operațiilor de intrare/ieșire sunt3,7,13,17, precizați care dintre\nprocese nu pot avea operații de intrare/ieșire de durată13.",
    "cod_sursa": "",
    "variante": {
      "a": "1s ,i3",
      "b": "2s ,i3",
  ...
  },
  {
    ...
    "materie": "Sisteme de calcul",
    "subcategorie": "Sisteme de operare",
    "enunt": "Într-un sistem sunt definite patru pagini cadru și opt pagini virtuale. La un moment daț în\ntimpul utilizării unui algoritm de paginare, după înlocuirea unei pagini din memorie cu pagina\n3, maparea în memorie este3,6,4,2. Știind că bitul R este setat și pentru a treia pagină cadru,\nestimați maparea paginilor în memorie după încercări de acces către paginile3,7,2,1,3,5,0(cu\nmențiunea că primul moment este cel din enunț), folosind algoritmul FIFO.",
    "cod_sursa": "",
    "variante": {
      "a": "0, 7, 5, 1",
      "b": "0, 7, 1, 5",
  ...
  },
  {
    ...
    "materie": "Sisteme de calcul",
    "subcategorie": "Sisteme de operare",
    "enunt": "Într-un sistem sunt definite patru pagini cadru și opt pagini virtuale. La un moment daț în timpul\nutilizării unui algoritm de paginare, după înlocuirea unei pagini din memorie cu pagina3, maparea\nîn memorie este3,6,4,2. S ,tiind că bitul R este setat și pentru a treia pagină cadru, estimați\nmaparea paginilor în memorie după încercări de acces către paginile3,7,2,1,3,5,0(cu mențiunea\ncă primul moment este cel din enunț), folosind algoritmul OPTIM (după ultimul moment se\nconsideră că paginile vor fi accesate în ordine strict crescătoare, de la0la7).",
    "cod_sursa": "",
    "variante": {
      "a": "3, 1, 0, 2",
      "b": "3, 0, 1, 2",
  ...
  },
  {
    ...
    "materie": "Sisteme de calcul",
    "subcategorie": "Sisteme de operare",
    "enunt": "Să considerăm o linie de asamblare de fabricație în care diferiți muncitori efectuează diferite sarcini\npentru a asambla un produs:\n(1) Furnizorii de componente care furnizează componentele necesare pentru procesul de asam-\nblare,\n(2) Asamblorii care primesc componentele și le asamblează în produsul final,\n(3) Inspectorii, care verifică calitatea produselor finite pentru a se asigura că îndeplinesc stan-\ndardele cerute,\n(4)Ambalatorii, careprimescproduseleinspectates ,ileambaleazăpentruexpedieresaudistribut ,ie,\n(5) Transportatorii care primesc produsele ambalate și le pregătesc pentru transport către clienți\nsau comercianți.\nPrin relaționarea acestui model cu procesele din UNIX, ce formă de comunicare între procese\ndescrie cel mai bine această interacțiune?",
    "cod_sursa": "",
    "variante": {
...
function loadQuestion() {
  ...
  varianteKeys.forEach(key => {
    ...
    button.innerHTML = `
      ...
      <span class="choice-text">${escapeHtml(choiceTextVal)}</span>
...
function renderStudyQuestions(questions) {
  ...
  questions.forEach(q => {
    ...
    Object.keys(q.variante).forEach(key => {
      ...
      choicesHtml += `
        <div class="study-choice-item ${correctClass}">
          <span class="choice-prefix">${key}</span>
          <span class="choice-text">${escapeHtml(q.variante[key])}</span>
        </div>
      `;
    });
    ...
    if (q.cod_sursa && q.cod_sursa.trim() !== "") {
      codeHtml = `
        <div id="code-block-container" style="background: rgba(7, 9, 19, 0.95); margin: 15px 0 10px 0;">
          <div class="code-header">
            <span class="code-lang">Python</span>
          </div>
          <pre><code style="color: #a5d6ff;">${escapeHtml(q.cod_sursa)}</code></pre>
        </div>
      `;
    }
