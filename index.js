...
const resumeSessionContainer = document.getElementById(
...
const explanationTextContent = document.getElementById(
...
const fallbackQuizData = [
  ...
  },
  {
    ...
    materie: "Algoritmi și structuri de date",
    enunt:
      "Care dintre următoarele afirmații este/sunt adevărată/adevărate pentru algoritmul corespunzător funcției de mai jos (se consideră că a este un tablou unidimensional cu n elemente)",
    cod_sursa:
    ...
    raspuns_corect: ["b"],
    explicatie:
      "Algoritmul execută o singură trecere printr-un algoritm asemănător Bubble Sort. Nu sortează întregul tablou (deci A și C sunt false), ci doar compară perechi adiacente și face swap dacă elementul din stânga e mai mic decât cel din dreapta. Consecința dieser singure treceri este că cel mai mic element din întregul tablou va fi împins spre dreapta până ajunge pe ultima poziție (a[n-1]). Astfel, toate celelalte elemente a[i] vor fi mai mari sau egale cu a[n-1].",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Algoritmi și structuri de date, Pb. 2",
    imagine: "",
  },
  {
    id: 3,
    materie: "Algoritmi și structuri de date",
    enunt:
      "Se consideră două valori naturale a și b și algoritmul descris prin (// specifică operația de determinare a câtului împărțirii întregi):",
    cod_sursa:
  ...
  },
  {
    ...
    materie: "Algoritmi și structuri de date",
    enunt:
      "Se consideră un tablou unidimensional, a[0..n−1], cu n = 10^10 valori numerice și se pune problema determinării primelor 10 valori în ordine crescătoare. Care dintre următoarele abordări asigură faptul că a[0..9] conține cele mai mici 10 elemente în ordine crescătoare și este mai eficientă?",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    materie: "Algoritmi și structuri de date",
    enunt:
      "Se consideră algoritmul alg apelat pentru un număr natural n și se notează cu T(n) numărul de operații de adunare efectuate. Care dintre următoarele afirmații este(sunt) adevarată(e)?",
    cod_sursa:
      "def alg(n):\n    if (n<2):\n        return(n)\n    else:\n        return(alg(n//2)+n%2)",
    variante: {
  ...
  },
  {
    ...
    raspuns_corect: ["a"],
    explicatie:
      "QuickSort (Sortarea rapidă) are o eficiență foarte bună pe caz mediu (liste mari cu elemente aleatoare), operând în O(n log n). Este ineficient pe liste gata ordonate (cazul defavorabil O(n^2)) dacă alegerea pivotului nu este optimizată, și există algoritmi mai simpli (ca Insertion Sort) preferabili pentru liste foarte scurte.",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Algoritmi și structuri de date, Pb. 6",
    imagine: "",
  },
  {
    id: 7,
    materie: "Algoritmi și structuri de date",
    enunt:
      "Se consideră șirul lui Fibonacci dat de relația de recurență F0 = 0, F1 = 1 și Fn+1 = Fn + Fn−1. De câte ori este evaluat F2 pentru a calcula F5 în cazul calculului termenului Fn în mod recursiv.",
    cod_sursa: "",
    variante: {
      a: "de 3 ori",
      b: "o dată",
    ...
    raspuns_corect: ["a"],
    explicatie:
      "Dezvoltând recursivitatea pentru F5 obținem un arbore de apeluri: F5 = F4 + F3. F4 devine (F3 + F2), iar F3-ul original devine (F2 + F1). Deja avem de două ori F2. Din F4 derivă (F3 + F2) = (F2 + F1 + F2). În total, ramurile coboară la evaluarea lui F2 de exact 3 ori.",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Algoritmi și structuri de date, Pb. 7",
    imagine: "",
  },
  {
    id: 8,
    materie: "Algoritmi și structuri de date",
    enunt:
      "Care din următoarele afirmații NU sunt adevărate în cazul algoritmului de căutare binară:",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    materie: "Algoritmi și structuri de date",
    enunt:
      "Se consideră următorul algoritm aplicat unui număr n de forma n = ck ck−1 . . . c1 c0. Dacă p este o variabilă (implicită) care contorizează numărul de execuții ale ciclului (contorul ciclului), care este proprietatea invariantă?",
    cod_sursa: "s = 0\nwhile n!=0:\n    d = n % 10\n    s = s+d\n    n = n//10",
    variante: {
  ...
  },
  {
    ...
    materie: "Algoritmi și structuri de date",
    enunt:
      "Fie A = {a1, ..., an} un multiset. Pentru a găsi S = {s1, ..., sk}, un subset al lui A folosind tehnica căutarii local optimale (căutare lacomă – greedy):",
    cod_sursa: "",
    variante: {
    ...
    raspuns_corect: ["a"],
    explicatie:
      "Aceasta este definiția fundamentală a algoritmilor Greedy: ei fac alegerea local optimă la fiecare pas sperând că aceasta va duce la soluția global optimă (Varianta A). Nu se întorc asupra deciziilor luate (deci varianta B, specifică backtracking-ului, este falsă).",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Algoritmi și structuri de date, Pb. 10",
    imagine: "",
  },
  {
    id: 11,
    ...
    raspuns_corect: ["a"],
    explicatie:
      "Aceasta este definiția exactă a listei simplu înlănțuite: fiecare nod conține datele și un pointer explicit (o referință) către următorul nod în memorie. Varianta B este falsă (tablourile au alocare contiguă, nu bazată pe pointeri), iar C se referă la liste circulare, care sunt un caz particular.",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Algoritmi și structuri de date, Pb. 11",
    imagine: "",
  },
  {
    id: 12,
  ...
  },
  {
    ...
    materie: "Algoritmi și structuri de date",
    enunt:
      "Care este complexitatea de inserare a unui element într-o listă înlănțuită sortată?",
    cod_sursa: "",
    variante: {
      a: "O(1).",
      b: "Θ(1).",
    ...
    raspuns_corect: ["c"],
    explicatie:
      "Deși operația efectivă de inserare a nodului (modificarea pointerilor) durează $O(1)$, pentru a menține lista sortată, trebuie mai întâi să traversezi lista secvențial pentru a găsi locul corect de inserare. În cel mai rău caz (elementul trebuie pus la final), asta presupune traversarea a 'n' elemente, rezultând o complexitate liniară de $O(n)$. Căutarea binară nu se poate aplica pe liste înlănțuite.",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Algoritmi și structuri de date, Pb. 13",
    imagine: "",
  },
  {
    id: 14,
    ...
    raspuns_corect: ["b", "d"],
    explicatie:
      "Stiva (Stack) funcționează după principiul LIFO (Last In First Out - varianta B corectă). Toate operațiile (Push și Pop) se fac la un singur capăt (Top), ceea ce înseamnă că elementul extras este mereu ultimul introdus (varianta D corectă). Varianta A descrie o coadă.",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Algoritmi și structuri de date, Pb. 14",
    imagine: "",
  },
  {
    id: 15,
    ...
    raspuns_corect: ["b", "d"],
    explicatie:
      "Coada (Queue) funcționează pe principiul rândului la magazin: primul venit este primul serviț adică FIFO (First In First Out), deci B este corectă. Datele se adaugă la un capăt (Tail/Spate) și se extrag de la celălalt capăt (Head/Față), deci D este corectă. Varianta C descrie o stivă.",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Algoritmi și structuri de date, Pb. 15",
    imagine: "",
  },
  {
    id: 16,
    materie: "Algoritmi și structuri de date",
    enunt:
      "În care din următoarele structuri de date, căutarea are complexitate (worst-case) O(log n)?",
    cod_sursa: "",
    variante: {
      a: "liste înlănțuite;",
      b: "heap;",
  ...
  },
  {
    ...
    materie: "Algoritmi și structuri de date",
    enunt:
      "Care din variantele de parcurgere a unui arbore binar de căutare poate fi folosită pentru afișarea tuturor nodurilor ordonate după cheia nodului.",
    cod_sursa: "",
    variante: {
    ...
    raspuns_corect: ["c"],
    explicatie:
      "Într-un arbore binar de căutare (BST), nodurile din subarborele stâng au valori mai mici decât rădăcina, iar cele din subarborele drept au valori mai mari. Parcurgerea în 'Inordine' (In-order traversal) vizitează nodurile în secvența: Stânga - Rădăcină - Dreapta. Datorită proprietății BSȚ acest proces garantează vizitarea elementelor în ordine strict crescătoare.",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Algoritmi și structuri de date, Pb. 17",
    imagine: "",
  },
  {
    id: 18,
    materie: "Algoritmi și structuri de date",
    enunt:
      "Care este înălțimea minimă a unui arbore binar de căutare cu N noduri?",
    cod_sursa: "",
    variante: {
      a: "O(1);",
      b: "O(N);",
  ...
  },
  {
    ...
    materie: "Algoritmi și structuri de date",
    enunt:
      "Care din afirmațiile următoare sunt adevărate referitoare la operația de căutare într-un arbore binar de căutare cu N noduri:",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    materie: "Algoritmi și structuri de date",
    enunt:
      "Fie următorul arbore binar de căutare, din care ștergem (prin copiere) nodul 40. Care dintre următoarele afirmații NU sunt adevărate: (A se studia Figura corespunzătoare problemei 20 din culegere)",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    materie: "Algoritmi și structuri de date",
    enunt:
      "Fie următorul arbore binar de cautare, din care stergem (prin copiere) nodul 20. Care dintre următoarele afirmaț ii sunt adevărate: (A se studia figura de la problema 21 din culegere)",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    materie: "Algoritmi și structuri de date",
    enunt:
      "Fie urmatorul arbore binar. Parcurgerea in postordine corecta a acestui arbore este: (A se studia figura de la problema 22 din culegere)",
    cod_sursa: "",
    variante: {
      a: "5,2,1,9,6,8,4,3",
      b: "1,9,2,4,3,8,6,5",
    ...
    raspuns_corect: ["b"],
    explicatie:
      "Parcurgerea în postordine (Post-order) urmează secvența: Subarbore Stâng -> Subarbore Drept -> Rădăcină. Aplicând recursiv acest tipar pe arborele prezentat în culegere, nodurile frunză sunt procesate primele de jos în suș iar rădăcina finală (5) este ultima. Se obține secvența 1, 9, 2, 4, 3, 8, 6, 5.",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Algoritmi și structuri de date, Pb. 22",
  ...
  },
  {
    ...
    materie: "Algoritmi și structuri de date",
    enunt:
      "Fie urmatorul arbore binar. Parcurgerea in inordine a acestui arbore este: (A se studia figura de la problema 23 din culegere)",
    cod_sursa: "",
    variante: {
    ...
    raspuns_corect: ["c"],
    explicatie:
      "Parcurgerea în inordine (In-order) vizitează nodurile astfel: Subarbore Stâng -> Rădăcină -> Subarbore Drept. Dacă aplicăm manual această regulă pe desenul din culegere, pornim de la stânga extremă și urcăm. Rădăcina principală (10) se va afla la mijlocul șirului. Secvența corectă este 1, 2, 9, 10, 16, 4, 18, 3.",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Algoritmi și structuri de date, Pb. 23",
  ...
  },
  {
    ...
    raspuns_corect: ["a"],
    explicatie:
      "Numărul maxim de noduri într-un arbore binar (inclusiv un heap) de înălțime 'h' se obține atunci când arborele este perfect complet (fiecare nivel este plin). Nivelul 0 are 1 nod, nivelul 1 are 2, nivelul 2 are 4... nivelul h are 2^h. Suma unei progresii geometrice 2^0 + 2^1 + ... + 2^h este fix 2^(h+1) - 1.",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Algoritmi și structuri de date, Pb. 25",
    imagine: "",
  },
  {
    id: 26,
    ...
    raspuns_corect: ["a"],
    explicatie:
      "Proprietatea de min-heap impune doar ca un părinte să fie mai mic sau egal cu descendenții săi (A[i] <= A[2i+1] și A[i] <= A[2i+2]), nu impune o ordine globală. De exemplu, array-ul [1, 5, 3] este un min-heap valid, dar nu este sortaț deci (1) este fals. În schimb, dacă un tablou este complet sortat crescător, proprietatea de părinte mai mic decât copiii este automat garantată, deci (2) este adevărat. Varianta A este corectă.",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Algoritmi și structuri de date, Pb. 26",
    imagine: "",
  },
  {
    id: 27,
    ...
    raspuns_corect: ["b"],
    explicatie:
      "Ștergerea minimului (rădăcinii) într-un min-heap se face prin plasarea ultimului element din heap pe poziția rădăcinii, urmată de o 'cernere în jos' (Heapify-Down / Sift-Down) pentru a restabili proprietatea de heap. În cel mai rău caz, acest element va fi coborât până la baza arborelui. Cum heap-ul este un arbore aproape compleț înălțimea sa este logaritmică, rezultând un timp de execuție O(log n).",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Algoritmi și structuri de date, Pb. 27",
    imagine: "",
  },
  {
    id: 28,
    ...
    enunt:
      "Se dau mulțimile A = {a, b, c}, B = {A, B, C, D} și C = {1, 2, 3, 4, 5}. Câte submulțimi ale mulțimii A ∪ B ∪ C conțin un element din A, două din B și cel puțin 4 elemente din C?",
    cod_sursa: "",
    variante: {
      a: "15",
      b: "14",
    ...
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Teoria grafurilor, Pb. 1",
    imagine: "",
  },
  {
    id: 29,
    materie: "Teoria grafurilor și combinatorică",
    enunt:
      "Câte numere întregi cuprinse între 1 și 1000 se divid cu 7, dar nu se divid cu 3?",
    cod_sursa: "",
    variante: {
      a: "93",
      b: "95",
    ...
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Teoria grafurilor, Pb. 2",
    imagine: "",
  },
  {
    id: 30,
    materie: "Teoria grafurilor și combinatorică",
    enunt:
      "În câte feluri putem forma un buchet cu cinci trandafiri dacă putem folosi trandafiri roșii, galbeni și albi? Ordinea punerii trandafirilor în buchet nu este relevantă.",
    cod_sursa: "",
    variante: {
      a: "21",
      b: "120",
  ...
  },
  {
    ...
    materie: "Teoria grafurilor și combinatorică",
    enunt:
      "Un mesaj transmis pe un canal de comunicare este o secvență de 2 tipuri de semnale: semnale de tip A care durează 1 microsecundă, și semnale de tip B care durează 2 microsecunde. Fie an numărul de mesaje diferite care durează n microsecunde. Care este valoarea lui a10?",
    cod_sursa: "",
    variante: {
      a: "89",
      b: "55",
  ...
  },
  {
    ...
    raspuns_corect: ["c"],
    explicatie:
      "Calculăm adresele din fiecare clasă pe baza biților liberi rămași din totalul de 32. Clasa A începe cu '0' (1 bit blocat) -> rămân 31 de biți liberi (2^31 adrese). Clasa B începe cu '10' (2 biți blocați) -> rămân 30 de biți (2^30). Clasa C începe cu '110' (3 biți blocați) -> rămân 29 de biți (2^29). Total adrese = 2^31 + 2^30 + 2^29. Aducând toutul la puterea cea mai mică (2^29), obținem: (2^2 * 2^29) + (2^1 * 2^29) + (1 * 2^29) = (4 + 2 + 1) * 2^29 = 7 * 2^29.",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Teoria grafurilor, Pb. 5",
    imagine: "",
  },
  {
    id: 33,
    materie: "Teoria grafurilor și combinatorică",
    enunt:
      "Fie rețeaua de transport G cu sursa s și destinația t. Care este valoarea fluxului maxim în G? (Referință la diagrama problemei 6 din culegere)",
    cod_sursa: "",
    variante: {
      a: "8",
      b: "5",
  ...
  },
  {
    ...
    materie: "Teoria grafurilor și combinatorică",
    enunt:
      "Fie graful ponderat. Ce greutate totală are arborele minim de acoperire al acestui graf? (Referință la diagrama problemei 7 din culegere)",
    cod_sursa: "",
    variante: {
      a: "229",
      b: "216",
  ...
  },
  {
    ...
    materie: "Teoria grafurilor și combinatorică",
    enunt:
      "Care din grafurile următoare este eulerian? (Referință la diagramele grafurilor G1, G2, G3, G4 din problema 8)",
    cod_sursa: "",
    variante: {
      a: "G1, G4",
      b: "G2, G3",
    ...
    raspuns_corect: ["b"],
    explicatie:
      "Pentru ca un graf neorientat și conex să fie Eulerian (adică să conțină un circuit care traversează fiecare muchie exact o dată), trebuie să îndeplinească o singură condiție absolută: gradul FIECĂRUI nod din graf trebuie să fie PAR. Dacă inspectăm vizual nodurile din figurile problemei 8, doar grafurile G2 și G3 conțin exclusiv noduri la care sunt conectate un număr par de muchii.",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Teoria grafurilor, Pb. 8",
  ...
  },
  {
    ...
    materie: "Teoria grafurilor și combinatorică",
    enunt:
      "Care din grafurile următoare are un cuplaj perfect? (Referință la diagramele G1, G2, G3, G4 din problema 9)",
    cod_sursa: "",
    variante: {
      a: "G1",
      b: "G2",
  ...
  },
  {
    ...
    raspuns_corect: ["e"],
    explicatie:
      "Pentru a calcula câți arbori distincti se pot forma folosind un set de 'n' noduri etichetate (numerotate), se folosește 'Teorema (sau Formula) lui Cayley'. Formula este n^(n-2). În cazul nostru, n = 5, așadar numărul de arbori diferiți este 5^(5-2) = 5^3 = 5 * 5 * 5 = 125.",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Teoria grafurilor, Pb. 10",
    imagine: "",
  },
  {
    id: 38,
    materie: "Teoria grafurilor și combinatorică",
    enunt:
      "Câte cuplaje maxime are graful bipartit complet K_{m,n} dacă 1 ≤ m ≤ n? Observați că un astfel de cuplaj trebuie să aibă m muchii.",
    cod_sursa: "",
    variante: {
      a: "m",
      b: "m + n",
    ...
    raspuns_corect: ["c"],
    explicatie:
      "Un cuplaj maxim într-un graf bipartit complet K_{m,n} (unde partițiile au dimensiunile m și n, cu m ≤ n) trebuie să acopere toate cele m noduri din partiția mai mică. Pentru primul din cele m noduri putem alege pereche oricare din cele n noduri din a doua partiție. Pentru al doilea nod alegem din cele n-1 rămase, și așa mai departe. Acesta este exact numărul de Aranjamente de n luate câte m, adică permutări parțiale, care se notează cu P(n,m) sau A_n^m.",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Teoria grafurilor, Pb. 11",
    imagine: "",
  },
  {
    id: 39,
    ...
    raspuns_corect: ["a"],
    explicatie:
      "Un graf complet K_n are o muchie între oricare două perechi de noduri distincte. Deoarece numărul total de perechi neordonate posibile dintr-o mulțime de n noduri este Combinări de n luate câte 2, graful are exact C(n, 2) muchii. (Formula extinsă pentru C(n,2) este n(n-1)/2).",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Teoria grafurilor, Pb. 12",
    imagine: "",
  },
  {
    id: 40,
    materie: "Teoria grafurilor și combinatorică",
    enunt:
      "Se presupune că n ≥ 3. Câte regiuni are o reprezentare planară a grafului bipartit complet K_{n,2}?",
    cod_sursa: "",
    variante: {
      a: "n + 1",
      b: "n",
  ...
  },
  {
    ...
    materie: "Teoria grafurilor și combinatorică",
    enunt:
      "Un șir ternar este un șir care conține doar cifrele 0,1 și 2. Fie a_n numărul șirurilor ternare de lungime n care nu conțin apariții consecutive ale cifrei 0. De exemplu, a_1 = 3 și a_2 = 8. Care din formulele următoare are loc pentru orice n ≥ 3:",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Teoria grafurilor, Pb. 15",
    imagine: "",
  },
  {
    id: 43,
    materie: "Teoria grafurilor și combinatorică",
    enunt:
      "Fie M_n mulțimea matricilor de dimensiune n x n cu elemente 0 sau 1. Pentru orice două matrici A, B ∈ M_n și 1 <= k <= n definim operațiile A ⊕ B și A ⊙_k B în felul următor: A ⊕ B = C ∈ M_n dacă C[i][j] = max(A[i][j], B[i][j]) și A ⊙_k B = D ∈ M_n dacă D[i][j] = A[i][k] * B[k][j] pentru toți 1 <= i, j <= n.\nFie G un graf simplu neorientat cu n noduri numerotate de la 1 la n, și A_G ∈ M_n matricea lui de adiacență.\n\nNumărul de grafuri neorientate simple cu n noduri numerotate de la 1 la n este:",
    cod_sursa: "",
    variante: {
      a: "2^{n(n−1)/2}",
      b: "2^n",
  ...
  },
  {
    ...
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Teoria grafurilor, Pb. 18",
    imagine: "",
  },
  {
    id: 46,
  ...
  },
  {
    ...
    materie: "Logică computațională",
    enunt:
      "Pentru următoarele formule propoziționale, și pentru interpretarea {P, ¬Q}:",
    cod_sursa: "",
    variante: {
    ...
    raspuns_corect: ["b", "c"],
    explicatie:
      "Interpretarea {P, ¬Q} înseamnă că P este Adevărat (T), iar Q este Fals (F). În varianta (a), implicația (P ⇒ Q) devine (T ⇒ F) care este Fals. Deci toată conjuncția devine Falsă, nu Adevărată. În varianta (b), (P ⇒ Q) este Falș iar (Fals ⇒ orice) este Adevăraț deci (b) evaluează la Adevărat. În (c), (P ∨ Q) este Adevăraț negația este Falș deci conjuncția devine Falsă, ceea ce se potrivește cu afirmația variantei. Pentru urmare, (b) și (c) sunt afirmații corecte.",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Logică computațională, Pb. 2",
    imagine: "",
  },
  {
    id: 48,
    ...
    raspuns_corect: ["a", "c"],
    explicatie:
      "O formulă este 'validă' dacă e adevărată pentru orice interpretare (tautologie). Este 'satisfiabilă' dacă e adevărată pentru CEL PUȚIN o interpretare. (a) este corectă: ce e valabil mereu, este valabil și de cel puțin o dată. Dacă o formulă 'nu este validă', înseamnă că are cel puțin o interpretare pentru care e Falsă. (b) este greșită pentru că o formulă poate fi adevărată uneori și falsă alteori (contingentă, deci satisfiabilă dar nevalidă). (c) este corectă: dacă e falsă măcar o dată, negația ei va fi adevărată măcar o dată (deci satisfiabilă). (d) este greșită, deoarece negația e validă doar dacă formula inițială e mereu falsă (nesatisfiabilă).",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Logică computațională, Pb. 3",
    imagine: "",
  },
  {
    id: 49,
    ...
    explicatie:
      "Dacă aplicăm echivalențele logice pentru implicație (X ⇒ Y ≡ ¬X ∨ Y): Prima formulă devine ¬(F ∧ G) ∨ H, care prin De Morgan este ¬F ∨ ¬G ∨ H. A doua formulă devine ¬F ∨ (¬G ∨ H), adică ¬F ∨ ¬G ∨ H. Deoarece au aceeași formă redusă, sunt logic echivalente (a). Fiind echivalente, fiecare o implică pe cealaltă, deci prima este consecință pentru a doua (b) și a doua consecință pentru prima (c).",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Logică computațională, Pb. 4",
    imagine: "",
  },
  {
    id: 50,
  ...
  },
  {
    ...
    materie: "Logică computațională",
    enunt:
      "Care din următoarele este un rezolvent al clauzelor {P, ¬Q, R} și {¬P, Q, S}?",
    cod_sursa: "",
    variante: {
      a: "∅",
      b: "{P, ¬P, R, S}",
  ...
  },
  {
    ...
    materie: "Logică computațională",
    enunt:
      "Pentru a verifica faptul că o formulă G este o consecință logică a formulelor F1, . . . , Fn, se poate:",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    materie: "Logică computațională",
    enunt:
      "Există o formulă logic echivalenta cu (...) ⇒ ¬(P3 ⇒ P6), care conține doar conectori propoziționali din mulțimea:",
    cod_sursa: "",
    variante: {
      a: "{¬, ∨}",
      b: "{∨, ∧}",
  ...
  },
  {
    ...
    materie: "Logică computațională",
    enunt:
      "Mulțimea de clauze ce corespunde formulei (¬P ⇒ (Q ∧ R)) ⇒ (P ⇒ ¬Q) este:",
    cod_sursa: "",
    variante: {
      a: "{{¬P, ¬Q}}",
      b: "{{P, ¬Q}, {P, R}, {¬Q, R}}",
    ...
    raspuns_corect: ["a"],
    explicatie:
      "Dacă reducem formula matematic pentru a o aduce la forma normală conjunctivă (mulțime de clauze): Membrul stâng e P ∨ (Q ∧ R), iar dreptul e ¬P ∨ ¬Q. Implicația totală devine ¬( P ∨ (Q ∧ R) ) ∨ ¬P ∨ ¬Q. Aplicând De Morgan, avem (¬P ∧ (¬Q ∨ ¬R)) ∨ ¬P ∨ ¬Q. Cum ¬P apare disjunctiv lângă grupul (¬P ∧ ...), grupul cu ȘI este 'absorbit' complet și dispare, rămânând pur și simplu ¬P ∨ ¬Q. Astfel, obținem o singură clauză: {¬P, ¬Q}, corespunzătoare opțiunii A.",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Logică computațională, Pb. 10",
    imagine: "",
  },
  {
    id: 56,
    materie: "Logică computațională",
    enunt:
      "Considerați mulțimea de clauze: (1) {P,Q,¬R}, (2) {¬P,R}, (3) {P,¬Q,S}, (4) {¬P,¬Q,¬R}, (5) {P,¬S}. Formula corespunzătoare acestei mulțimi este:",
    cod_sursa: "",
    variante: {
      a: "validă",
      b: "satisfiabilă",
  ...
  },
  {
    ...
    materie: "Logică computațională",
    enunt:
      "Pentru a demonstra o formulă G când se cunoaște o disjuncție A ∨ B:",
    cod_sursa: "",
    variante: {
    ...
    raspuns_corect: ["a"],
    explicatie:
      "Aceasta este regula eliminării disjuncției (sau raționamentul prin cazuri). Deoarece știm sigur că măcar unul dintre evenimentele A sau B este adevăraț pentru a demonstra că G decurge din ele, trebuie să demonstrăm G pe ambele ramuri posibile: analizăm cazul în care A este adevărat și deducem G, apoi analizăm separat cazul în care B este adevărat și deducem G.",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Logică computațională, Pb. 13",
    imagine: "",
  },
  {
    id: 59,
    materie: "Logică computațională",
    enunt:
      "Fie P,Q,R variabile propoziționale. Care din formulele propoziționale de mai jos corespund funcției booleene cu trei argumente care returnează A dacă argumentele sale reprezintă codificarea binară a unui număr prim?",
    cod_sursa: "",
    variante: {
      a: "P ∧ Q ∧ ¬R",
      b: "(¬P ∧ Q) ∨ (P ∧ R)",
  ...
  },
  {
    ...
    materie: "Logică computațională",
    enunt:
      "Fie mulțimea de clauze: {{¬P,¬Q,R}, {P,¬Q,¬R}, {¬P,R}, {P,¬Q,R}, {¬Q,¬R}} . Primul pas în aplicarea metodei Davis Putnam asupra mulțimii de clauze consistă în:",
    cod_sursa: "",
    variante: {
    ...
    raspuns_corect: ["b"],
    explicatie:
      "În metoda Davis-Putnam, se caută mai întâi simplificări evidente. Un 'literal pur' este un literal care apare într-o mulțime de clauze doar cu o singură polaritate (fie doar afirmaț fie doar negat). Observăm că 'Q' nu apare deloc ca afirmat (pozitiv) în nicio clauză, ci apare doar sub forma '¬Q' în clauzele 1, 2, 4 și 5. Deci ¬Q este un literal pur, iar DP va simplifica sistemul atribuindu-i valoarea Adevărat. Ultima clauză nu are un singur literal (are doi), deci (d) e falsă.",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Logică computațională, Pb. 15",
    imagine: "",
  },
  {
    id: 61,
    ...
    enunt:
      "Limbajul generat de gramatica G = (VN, VT, S, P), unde VN = {S}; VT = {a, b}; P = {S → aSb|aAb, A → aA|λ}, este:",
    cod_sursa: "",
    variante: {
      a: "L = {a^m b^n | m ≥ n ≥ 1}",
  ...
  },
  {
    ...
    materie: "Limbaje formale și teoria automatelor",
    enunt:
      "Regulile gramaticii G = (VN, VT, S, P), unde VN = {S}, VT = {PCR, PDAR, UDMR}, P = {S → PCR | PDAR | UDMR}, respectă restricțiile impuse gramaticilor:",
    cod_sursa: "",
    variante: {
      a: "regulate (tip 3)",
    ...
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Limbaje formale, Pb. 2",
    imagine: "",
  },
  {
    id: 63,
    materie: "Limbaje formale și teoria automatelor",
    enunt:
      "Regulile gramaticii G = (VN, VT, S, P), unde P = {S → abc | aAbc, Ab → bA, Ac → Bbcc, bB → Bb, aB → aaA | aa}, respectă restricțiile impuse gramaticilor:",
    cod_sursa: "",
    variante: {
      a: "regulate (tip 3)",
      b: "independente de context (tip 2)",
  ...
  },
  {
    ...
    materie: "Limbaje formale și teoria automatelor",
    enunt:
      "Expresia regulată ce notează limbajul L = {w | șiruri de 0 și 1 ce conțin cel putin un simbol 1}, este:",
    cod_sursa: "",
    variante: {
      a: "(0|1)∗1",
      b: "1 | (0|1)∗1(1|0)∗",
    ...
    raspuns_corect: ["b", "d"],
    explicatie:
      "Un șir care conține cel puțin un '1' poate avea orice fel de combinații de 0 și 1 înainte de '1', și orice fel de combinații de 0 și 1 după '1'. Varianta D descrie exact asta: (0|1)* înseamnă orice combinație, apoi urmează obligatoriu un 1, urmat iar de orice combinație (0|1)*. Varianta B o include și pe D în ramura dreaptă a disjuncției, fiind de asemenea complet corectă funcțional.",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Limbaje formale, Pb. 4",
    imagine: "",
  },
  {
    id: 65,
    ...
    raspuns_corect: ["d"],
    explicatie:
      "Expresia regulată are două ramuri delimitate de operatorul SAU (|). Prima ramură este '01*', care înseamnă un '0' urmat de oricâte cifre de '1' (adică 01^n, cu n ≥ 0). A doua ramură este pur și simplu cifra '1'. Limbajul rezultat este reuniunea acestor două seturi posibile, ceea ce este exprimat perfect de varianta (d).",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Limbaje formale, Pb. 5",
    imagine: "",
  },
  {
    id: 66,
    ...
    raspuns_corect: ["b", "d"],
    explicatie:
      "Analizăm finalul expresiei regulate: ea se termină cu '0(0|1)'. Asta înseamnă că ultimele două caractere ale oricărui șir generat trebuie să fie '00' sau '01'. Prin urmare, penultimul caracter este obligatoriu '0' (varianta D). Impliciț șirul se termină strict cu grupurile 00 sau 01 (varianta B).",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Limbaje formale, Pb. 6",
    imagine: "",
  },
  {
    id: 67,
    materie: "Limbaje formale și teoria automatelor",
    enunt:
      "Dacă L1 este un limbaj regulat iar despre L2 nu se cunoaște tipul dar L1 \\ L2 este regulaț atunci L2 poate să fie:",
    cod_sursa: "",
    variante: {
      a: "mulțimea vidă",
    ...
    explicatie:
      "Dacă diferența de limbaje L1 \\ L2 este un limbaj regulaț limbajul L2 poate aparține teoretic oricărei clase din ierarhie (dacă elementele care diferă se elimină în mod convenabil sau pur și simplu nu se suprapun). Dacă L2 este mulțimea vidă (a), L1 \\ ∅ = L1, care știam că e regulat. Poate fi regulat (d). Poate fi independent de context (b) (de ex: un L2 care nu are nicio intersecție cu L1, rezultând din nou tot L1).",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Limbaje formale, Pb. 7",
    imagine: "",
  },
  {
    id: 68,
    materie: "Limbaje formale și teoria automatelor",
    enunt:
      "Aplicând Lema de pompare pentru un limbaj regulaț considerăm un cuvânt w suficient de lung care aparține limbajului L și îl descompunem în ...... părți.",
    cod_sursa: "",
    variante: {
      a: "2",
      b: "5",
    ...
    raspuns_corect: ["c"],
    explicatie:
      "Lema de pompare (Pumping Lemma) pentru limbaje regulate afirmă că orice cuvânt 'w' dintr-un limbaj regulat (care este mai lung decât o constantă 'p') poate fi partiționat în exact 3 părți: w = xyz, cu anumite proprietăți (y nu e vid, iar x(y^n)z aparține limbajului pentru orice n).",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Limbaje formale, Pb. 8",
    imagine: "",
  },
  {
    id: 69,
    materie: "Limbaje formale și teoria automatelor",
    enunt:
      "O producție de forma A → B, unde A și B nu sunt terminale, se numește:",
    cod_sursa: "",
    variante: {
    ...
    raspuns_corect: ["b"],
    explicatie:
      "O producție unitară (în care un neterminal produce exact un alt neterminal singur) se numește 'regulă de redenumire' (sau producție unitară). În timpul algoritmilor de simplificare a gramaticilor, aceste reguli sunt eliminate prin expandare, tocmai pentru că ele funcționează doar ca un alias.",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Limbaje formale, Pb. 9",
    imagine: "",
  },
  {
    id: 70,
    materie: "Limbaje formale și teoria automatelor",
    enunt:
      "Care dintre producțiile de mai jos poate fi acceptată de gramatica în formă normală Chomsky, unde A, B, C și S sunt neterminale iar a este terminal?",
    cod_sursa: "",
    variante: {
      a: "A → BC",
      b: "A → a",
    ...
    raspuns_corect: ["a", "b", "c"],
    explicatie:
      "Prin definiție, o gramatică este în Forma Normală Chomsky (FNC) dacă TOATE regulile ei au una dintre cele două forme de bază: un neterminal produce alte două neterminale (A → BC, varianta a), sau un neterminal produce exact un terminal (A → a, varianta b). Adițional, regula S → λ (varianta c) este tolerată și acceptată dacă limbajul respectiv conține cuvântul vid.",
    referinta_sursa:
      "Tematica 1: Structuri discrete și algoritmi - Limbaje formale, Pb. 10",
    imagine: "",
  },
  {
    id: 71,
    materie: "Limbaje formale și teoria automatelor",
    enunt:
      "Care dintre următoarele seturi de reguli corespund unei gramatici în formă normală Chomsky?",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    materie: "Limbaje formale și teoria automatelor",
    enunt:
      "Fie L limbajul generat de gramatica G = (V_N, V_T, S, P), unde V_N = {S, A, B, C, X, Y, Z}, V_T = {a, b, c}, iar regulile de producție P sunt:\n\nAlegeți răspunsurile corecte.",
    cod_sursa:
      "S → λ | AX | BY | CZ\nX → λ | BY | CZ\nY → λ | AX | CZ\nZ → λ | AX | BY\nA → a\nB → b\nC → c",
    variante: {
  ...
  },
  {
    ...
    subcategorie: "Limbajul Python",
    enunt:
      "Considerând secvența de cod, care dintre secvențele de cod de mai jos returnează șirul de caractere 'aom'?",
  ...
  },
  {
    ...
    subcategorie: "Limbajul Python",
    enunt:
      "Este sigur să folosim operatorul==pentru a verifica dacă două variabile de tipfloatsunt egale ?",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    subcategorie: "Limbajul Python",
    enunt:
      "Care dintre opțiunile de mai jos reprezintă o inițializare corectă a unui dicționar:",
    cod_sursa: "",
    variante: {
      a: "d = (’nume’: ’valoare’)",
      b: "d = ’nume’: ’valoare’",
  ...
  },
  {
    ...
    subcategorie: "Limbajul Python",
    enunt:
      "Fie următoarea secvență de cod. Cum putem apela metoda salut() din clasa Persoana?",
    cod_sursa:
  ...
  },
  {
    ...
    subcategorie: "Limbajul Python",
    enunt:
      "Care dintre variantele de mai jos deschide un fișier pentru scriere?",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    subcategorie: "Limbajul C",
    enunt:
      "La execuția programului următor se tastează 20. Ce se va afișa după execuție?",
    cod_sursa:
      '#include<stdio.h>\nvoid main() {\nchar a;\nscanf("%c",&a);\nprintf("%c",a); }',
    variante: {
      a: "20;",
  ...
  },
  {
    ...
    subcategorie: "Limbajul C",
    enunt:
      "Care este rezultatul numeric al evaluării expresiei:\na<b<c\ndacă a=-2, b=-1 si c=0?",
    cod_sursa: "",
    variante: {
      a: "1;",
      b: "TRUE;",
  ...
  },
  {
    ...
    subcategorie: "Limbajul C",
    enunt:
      "Care din următoarele variante reprezintă modalități de comunicare între funcții?",
    cod_sursa: "",
    variante: {
      a: "apel;",
  ...
  },
  {
    ...
    subcategorie: "Limbajul C++",
    enunt:
      "Un constructor se caracterizează prin următoarele proprietăți în limbajele C++/Java:",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    subcategorie: "Limbajul C++",
    enunt:
      "Care dintre următoarele afirmații sunt adevărate despre template-uri(C++)/generice(Java)?",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    subcategorie: "Limbajul C++",
    enunt:
      "Care dintre următoarele afirmații sunt adevărate în limbajele C++/Java?",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    subcategorie: "Limbajul C++",
    enunt:
      "Principiul OCP (Open Close Principle) din cadrul principiilor SOLID se referă la:",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    subcategorie: "Limbajul C++",
    enunt:
      "Care din următoarele afirmații sunt false în contextul supraîncărcării operatorilor în limbajul\nC++:",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    subcategorie: "Limbajul C++",
    enunt:
      "În limbajul C++, dacă o clasă X are ca membri variabile pointer, este recomandat să conțină:",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    subcategorie: "Limbajul C++",
    enunt:
      "Se dă următoarea secvență de cod. De câte ori sunt apelați constructorii clasei Date?",
    cod_sursa:
  ...
  },
  {
    ...
    enunt:
      "Dacă o metodă are ca parametru o referință la un obiect imutabil, de exemplu clasa String, poate\nmetoda să modifice starea obiectului?",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    subcategorie: "Limbajul Java",
    enunt:
      "Care dintre afirmațiile de mai jos este adevărată în relație cu limbajul Java?",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    subcategorie: "Limbajul Java",
    enunt:
      "Care dintre afirmațiile de mai jos este/sunt adevărată/e despre conceptul de moștenire între clase?",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    subcategorie: "Limbajul Java",
    enunt:
      "Care dintre afirmațiile de mai jos este/sunt adevărată/e referitor la conceptul de clasă abstractă\nîn limbajul Java:",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    subcategorie: "Limbajul Java",
    enunt:
      "Care dintre afirmațiile de mai jos sunt adevărate despre clase și obiecte:",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    subcategorie: "Limbajul Java",
    enunt:
      "Care din următoarele afirmații sunt false relativ la limbajul Java:",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    subcategorie: "Limbajul Java",
    enunt:
      "Care din următoarele afirmații este/sunt adevărate despre clasa PreparedStatement?",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    subcategorie: "Limbajul Java",
    enunt:
      "Două funcții care au același nume într-o clasă Java, pot fi diferențiate datorită:",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    subcategorie: "Limbajul Java",
    enunt:
      "Se consideră următoarea secvență de cod. Care din variantele de mai jos instantiază și lansează în execuție un fir de execuție de tipul clasei A?",
    cod_sursa:
  ...
  },
  {
    ...
    subcategorie: "Limbajul Java",
    enunt:
      "Considerând următoarea secvență de cod, stabiliți care este ordinea execuției (în ipoteza că o clasă are un constructor, o metodă, un bloc static și un bloc de instanță):",
    cod_sursa:
  ...
  },
  {
    ...
    cod_sursa: "",
    variante: {
      a: "Asociere bidirecțională, între clasele Proiect și CodSursa; compoziție între clasele Proiect (compozit) și DiagramaUML (componenta); agregare între clasele Proiect (agregat) și Student (componenta); generalizare între interfața IStudent (implementată) și clasa Student (implementează); realizare între clasa Student (superclasa) și clasa Bursier (subclasa)",
      b: "Asociere bidirecțională, între clasele Proiect și CodSursa; compoziție între clasele Proiect (compozit) și DiagramaUML (componenta); agregare între clasele Proiect (agregat) și Student (componenta); realizare între interfața IStudent (implementată) și clasa Student (implementează); generalizare între clasa Student (superclasa) și clasa Bursier (subclasa)",
      c: "Asociere bidirecțională, între clasele Proiect și CodSursa; agregare între clasele Proiect (agregat) și DiagramaUML (componenta); compoziție între clasele Proiect (agregat) și Student (componenta); realizare între interfața IStudent (implementată) și clasa Student (implementează); generalizare între clasa Student (superclasa) și clasa Bursier (subclasa)",
      d: "Asociere bidirecțională, între clasele Proiect și CodSursa; compoziție între clasele DiagramaUML (compozit) și Proiect (componenta); agregare între clasele Student (agregat) și Proiect (componenta); realizare între interfața IStudent (implementată) și clasa Student (implementează); generalizare între clasa Student (superclasa) și clasa Bursier (subclasa)",
    },
    raspuns_corect: ["b"],
    explicatie: "",
  ...
  },
  {
    ...
    subcategorie: "Proiectarea aplicațiilor software",
    enunt:
      "Fie următoarea diagramă de robustețe.\nCare afirmații sunt adevărate?",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    subcategorie: "Proiectarea aplicațiilor software",
    enunt:
      "Selectați metodele de evitare a introducerii de erori în dezvoltarea de programe:",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    enunt:
      "Se consideră tabela R(A) conținând înregistrările {(1), (2)} și tranzacțiile T1 și T2. Dacă tranzacția T2 se execută folosind nivelul de izolare repeatable read, care dintre următoarele afirmații este adevărată?",
    cod_sursa:
  ...
  },
  {
    ...
    subcategorie: "Baze de date",
    enunt:
      "Trei dintre expresiile relaționale de mai jos returnează numele studenților care nu au aplicat\nla specializările CS sau PH. Care returnează altceva? (Observație: numele studenților pot fi\nduplicate.)",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    subcategorie: "Baze de date",
    enunt:
      "Tabelul de mai jos conține un eșantion de date reprezentativ pentru toate dependențele funcționale dintr-un set de date real. Care sunt dependențele funcționale ce pot fi extrase din aceste date?",
    cod_sursa: "",
    variante: {
      a: "A→{B, C}, E→{F}",
      b: "D→{A, B, C, E, F}, F→{E}",
  ...
  },
  {
    ...
    subcategorie: "Baze de date",
    enunt:
      "Relativ la relația R de mai suș care dintre următoarele afirmații sunt false?",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    subcategorie: "Baze de date",
    enunt:
      "Presupunem că în tabela EMPLOYEES sunt 10 angajați care au salarii de 1000 euro fiecare, cu excepția unuia care are valoarea NULL și că primii 5 angajați lucrează în departamentul 1 și ceilalți 5 angajați în departamentul 2. Câte linii va afișa interogarea următoare:",
    cod_sursa:
  ...
  },
  {
    ...
    subcategorie: "Baze de date",
    enunt:
      "Care dintre interogările de mai jos selectează identificatorul (ID) și numele departamentelor care\nnu au angajați? Coloana DEPARTMENT_ID este comună tabelelor EMPLOYEES și DEPARTMENTS.",
    cod_sursa: "",
    variante: {
  ...
  },
  {
    ...
    subcategorie: "Baze de date",
    enunt:
      "Dacă se dorește afișarea tuturor locațiilor care nu au niciun departamenț precum și a departamentelor care nu au fost asignate niciunei locații, ce tip de JOIN între tabelele DEPARTMENTS\nși LOCATIONS va afișa aceste informații ca parte din liniile returnate?",
    cod_sursa: "",
    variante: {
      a: "NATURAL JOIN",
      b: "FULL OUTER JOIN",
  ...
  },
  {
    ...
    subcategorie: "Baze de date",
    enunt:
      "Prin următoarea instrucțiune SQL se dorește a regăsi liniile din tabelul ORDER_ITEMS aferente produselor identificate prin PRODUCT_ID care au un UNIT_PRICE mai mare decât 1000 și care au fost comandate de mai mult de 5 ori. Care afirmații sunt adevărate cu privire la instrucțiunea SQL:",
    cod_sursa:
  ...
  },
  {
    ...
    subcategorie: "Baze de date",
    enunt:
      "Evaluați următoarea instrucțiune CREATE TABLE. Care afirmații sunt adevărate cu privire la constrângerea PROD_ID_PK?",
    cod_sursa:
  ...
  },
  {
    ...
    subcategorie: "Baze de date",
    enunt:
      "Fiind dată vederea V de mai jos, în ce condiții comanda SQL de mai jos va genera o excepție cauzată de constrângerea WITH CHECK OPTION?",
    cod_sursa:
  ...
  },
  {
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Arhitectura calculatoarelor, Pb. 1",
    imagine: "",
  },
  {
    id: 148,
    ...
    subcategorie: "Arhitectura calculatoarelor",
    enunt:
      "Timpul mediu necesar pentru a accesa o locație de memorie și a prelua conținutul acesteia poartă\nnumele de:",
    cod_sursa: "",
    variante: {
      a: "timp de latență",
      b: "timp de căutare",
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Arhitectura calculatoarelor, Pb. 2",
    imagine: "",
  },
  {
    id: 149,
    ...
    subcategorie: "Arhitectura calculatoarelor",
    enunt:
      "Tipul de memorie folosit pentru a crește viteza de procesare a unui calculator este:",
    cod_sursa: "",
    variante: {
      a: "RAM",
      b: "Cache",
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Arhitectura calculatoarelor, Pb. 3",
    imagine: "",
  },
  {
    id: 150,
    ...
    subcategorie: "Arhitectura calculatoarelor",
    enunt:
      "Suma dintre -6 și – 13, folosind reprezentarea în complement față de 2, este:",
    cod_sursa: "",
    variante: {
      a: "11101101",
      b: "11100001",
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Arhitectura calculatoarelor, Pb. 4",
    imagine: "",
  },
  {
    id: 151,
    ...
    subcategorie: "Arhitectura calculatoarelor",
    enunt:
      "Care este valoarea stocată la adresa c după executarea următoarei secvențe de cod?",
    cod_sursa:
      "x     DATA 4B\ny     DATA F\nc     DATA 0\nstart LDA x\n      CMP y\n      JGE adr1\n      ADD y\n      STA c\n      JMP adr2\nadr1  SUB y\n      STA c\nadr2  STOP\n      END start",
    variante: {
      a: "3C 16",
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Arhitectura calculatoarelor, Pb. 5",
    imagine: "",
  },
  {
    id: 152,
    ...
    subcategorie: "Arhitectura calculatoarelor",
    enunt:
      "Ce tehnică ajută procesorul să ruleze un program concomitent cu operațiile de intrare/ieșire?",
    cod_sursa: "",
    variante: {
      a: "DMA",
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Arhitectura calculatoarelor, Pb. 6",
    imagine: "",
  },
  {
    id: 153,
    ...
    subcategorie: "Arhitectura calculatoarelor",
    enunt:
      "Care este cea mai mare unitate de transfer a datelor din memoria unui sistem de calcul?",
    cod_sursa: "",
    variante: {
      a: "cuvânt",
      b: "bloc",
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Arhitectura calculatoarelor, Pb. 7",
    imagine: "",
  },
  {
    id: 154,
    ...
    subcategorie: "Arhitectura calculatoarelor",
    enunt:
      "Pentru un număr dat/fix de biți, numărul de valori distincte care pot fi reprezentate este:",
    cod_sursa: "",
    variante: {
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Arhitectura calculatoarelor, Pb. 8",
    imagine: "",
  },
  {
    id: 155,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Arhitectura calculatoarelor, Pb. 9",
    imagine: "",
  },
  {
    id: 156,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Arhitectura calculatoarelor, Pb. 10",
    imagine: "",
  },
  {
    id: 157,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Arhitectura calculatoarelor, Pb. 11",
    imagine: "",
  },
  {
    id: 158,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Arhitectura calculatoarelor, Pb. 12",
    imagine: "",
  },
  {
    id: 159,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Arhitectura calculatoarelor, Pb. 13",
    imagine: "",
  },
  {
    id: 160,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Arhitectura calculatoarelor, Pb. 14",
    imagine: "",
  },
  {
    id: 161,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Arhitectura calculatoarelor, Pb. 15",
    imagine: "",
  },
  {
    id: 162,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Arhitectura calculatoarelor, Pb. 16",
    imagine: "",
  },
  {
    id: 163,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Arhitectura calculatoarelor, Pb. 17",
    imagine: "",
  },
  {
    id: 164,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Arhitectura calculatoarelor, Pb. 18",
    imagine: "",
  },
  {
    id: 165,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Arhitectura calculatoarelor, Pb. 19",
    imagine: "",
  },
  {
    id: 166,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Arhitectura calculatoarelor, Pb. 20",
    imagine: "",
  },
  {
    id: 167,
    ...
    subcategorie: "Arhitectura calculatoarelor",
    enunt:
      "În cazul familiei de procesoare x86, registrul pointer de instrucțiuni (IP – Instruction Pointer)",
    cod_sursa: "",
    variante: {
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Arhitectura calculatoarelor, Pb. 21",
    imagine: "",
  },
  {
    id: 168,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Arhitectura calculatoarelor, Pb. 22",
    imagine: "",
  },
  {
    id: 169,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Arhitectura calculatoarelor, Pb. 23",
    imagine: "",
  },
  {
    id: 170,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Arhitectura calculatoarelor, Pb. 24",
    imagine: "",
  },
  {
    id: 171,
    ...
    subcategorie: "Arhitectura calculatoarelor",
    enunt:
      "Reprezentarea în virgulă mobilă, simplă precizie, a numărului zecimal−12,25este:",
    cod_sursa: "",
    variante: {
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Arhitectura calculatoarelor, Pb. 25",
    imagine: "",
  },
  {
    id: 172,
    ...
    enunt:
      "Care dintre următoarele mecanisme pot fi folosite pentru o implementare corectă a problemei\nsecțiunii critice fără utilizarea asteptării active?",
    cod_sursa: "",
    variante: {
      a: "semafoare",
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 1",
    imagine: "",
  },
  {
    id: 173,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 2",
    imagine: "",
  },
  {
    id: 174,
    ...
    subcategorie: "Sisteme de operare",
    enunt:
      "Care dintre problemele clasice de comunicare între procese pune în evidență o situație de impas?",
    cod_sursa: "",
    variante: {
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 3",
    imagine: "",
  },
  {
    id: 175,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 4",
    imagine: "",
  },
  {
    id: 176,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 5",
    imagine: "",
  },
  {
    id: 177,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 6",
    imagine: "",
  },
  {
    id: 178,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 7",
    imagine: "",
  },
  {
    id: 179,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 8",
    imagine: "",
  },
  {
    id: 180,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 9",
    imagine: "",
  },
  {
    id: 181,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 10",
    imagine: "",
  },
  {
    id: 182,
    ...
    subcategorie: "Sisteme de operare",
    enunt:
      "Care dintre următoarele operații reprezintă operații atomice permise asupra semafoarelor?",
    cod_sursa: "",
    variante: {
      a: "wait",
      b: "up",
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 11",
    imagine: "",
  },
  {
    id: 183,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 12",
    imagine: "",
  },
  {
    id: 184,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 13",
    imagine: "",
  },
  {
    id: 185,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 14",
    imagine: "",
  },
  {
    id: 186,
    ...
    subcategorie: "Sisteme de operare",
    enunt:
      "Fiecare dintre procesele P_i, cu i = 0, 1, ..., 9 este caracterizat prin următoarea secvență de cod. Într-un al 11-lea proces P_10, liniile up(mutex) și down(mutex) au fost inversate. Care este numărul maxim de procese care s-ar putea găsi simultan în regiunea critică în acest caz, știind că inițial este permisă trecerea prin mutex?",
    cod_sursa:
      "repeat\n  down(mutex)\n  {Critical Section}\n  up(mutex)\nforever",
    variante: {
      a: "1",
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 15",
    imagine: "",
  },
  {
    id: 187,
    ...
    subcategorie: "Sisteme de operare",
    enunt:
      "Într-un sistem se găsesc trei procese concurente, care conțin următoarele bucăți de cod, sincronizate prin trei semafoare binare. Semafoarele sunt inițializate cu valorile S_0 = 1, S_1 = 0 și S_2 = 0. De câte ori va executa primul proces linia print '0'?",
    cod_sursa:
      "Process P0\nwhile(true)\n{\n  down(S0);\n  print '0';\n  up(S1);\n  up(S2);\n}\n\nProcess P1\ndown(S1);\nup(S0);\n\nProcess P2\ndown(S2);\nup(S0);",
    variante: {
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 16",
    imagine: "",
  },
  {
    id: 188,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 17",
    imagine: "",
  },
  {
    id: 189,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 18",
    imagine: "",
  },
  {
    id: 190,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 19",
    imagine: "",
  },
  {
    id: 191,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 20",
    imagine: "",
  },
  {
    id: 192,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 21",
    imagine: "",
  },
  {
    id: 193,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 22",
    imagine: "",
  },
  {
    id: 194,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 23",
    imagine: "",
  },
  {
    id: 195,
    ...
    subcategorie: "Sisteme de operare",
    enunt:
      "Se consideră un sistem cu 10 procese concurente. Fiecare proces petrece 60% din timpul său\nașteptând operații I/O. Care va fi procentul de utilizare al procesorului?",
    cod_sursa: "",
    variante: {
      a: "∼100%",
      b: "∼60%",
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 24",
    imagine: "",
  },
  {
    id: 196,
    ...
    subcategorie: "Sisteme de operare",
    enunt:
      "Într-un sistem cu fire de execuție, există câte o stivă pe fir sau o stivă pe proces atunci când sunt\nutilizate fire de execuție la nivel de utilizator și fire de execuție la nivel de kernel?",
    cod_sursa: "",
    variante: {
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 25",
    imagine: "",
  },
  {
    id: 197,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 26",
    imagine: "",
  },
  {
    id: 198,
    ...
    subcategorie: "Sisteme de operare",
    enunt:
      "Se consideră următorul cod C; câte procese copil sunt create la executarea acestui program?",
    cod_sursa: "void main() {\nfork();\nfork();\nexit();\nfork();\n}",
    variante: {
      a: "2",
      b: "3",
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 27",
    imagine: "",
  },
  {
    id: 199,
    ...
    subcategorie: "Sisteme de operare",
    enunt:
      "Pentru adresa virtuală zecimală 20202, calculați numărul paginii virtuale și offset-ul, știind că\ndimensiunea unei pagini este 4 KB:",
    cod_sursa: "",
    variante: {
      a: "16, 3818",
      b: "4, 3818",
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 28",
    imagine: "",
  },
  {
    id: 200,
    ...
    subcategorie: "Sisteme de operare",
    enunt:
      'Aplicația de mai jos citește dintr-un fișier ce conține doar șirul de caractere "licență". Care va fi\nmesajul afișat pe ecran dacă citirea este reușită:',
    cod_sursa:
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 29",
    imagine: "",
  },
  {
    id: 201,
    ...
    subcategorie: "Sisteme de operare",
    enunt:
      "Următorul fragment de cod ar trebui să folosească pipe-uri pentru a comunica între procesul copil și procesul părinte. Este ceva în neregulă cu mecanismul de pipe-uri din fragmentul de cod de mai jos?",
    cod_sursa:
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 30",
    imagine: "",
  },
  {
    id: 202,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 31",
    imagine: "",
  },
  {
    id: 203,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Sisteme de operare, Pb. 32",
    imagine: "",
  },
  {
    id: 204,
    ...
    enunt:
      "Intr-un segment TCP ce câmp permite nodului receptor să determine dacă un segment TCP a\nfost deteriorat în timpul transmisiei?",
    cod_sursa: "",
    variante: {
      a: "suma de control;",
      b: "flags;",
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Rețele de calculatoare, Pb. 1",
    imagine: "",
  },
  {
    id: 205,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Rețele de calculatoare, Pb. 2",
    imagine: "",
  },
  {
    id: 206,
    ...
    subcategorie: "Rețele de calculatoare",
    enunt:
      "Pentru a asigura integritatea datelor, protocoalele orientate pe conexiune (ca TCP) folosesc:",
    cod_sursa: "",
    variante: {
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Rețele de calculatoare, Pb. 3",
    imagine: "",
  },
  {
    id: 207,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Rețele de calculatoare, Pb. 4",
    imagine: "",
  },
  {
    id: 208,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Rețele de calculatoare, Pb. 5",
    imagine: "",
  },
  {
    id: 209,
    ...
    subcategorie: "Rețele de calculatoare",
    enunt:
      "Care din următoarele adrese IP se încadrează în blocul CIDR din 115.64.4.0/22? (Alegeti două.)",
    cod_sursa: "",
    variante: {
      a: "115.64.8.32;",
      b: "115.64.6.255;",
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Rețele de calculatoare, Pb. 6",
    imagine: "",
  },
  {
    id: 210,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Rețele de calculatoare, Pb. 7",
    imagine: "",
  },
  {
    id: 211,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Rețele de calculatoare, Pb. 8",
    imagine: "",
  },
  {
    id: 212,
    ...
    subcategorie: "Rețele de calculatoare",
    enunt:
      "Care din următoarele adrese IP este un exemplu valid de adresă IPv4 ?",
    cod_sursa: "",
    variante: {
      a: "144.92.254.253;",
      b: "144-92-43-178;",
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Rețele de calculatoare, Pb. 9",
    imagine: "",
  },
  {
    id: 213,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Rețele de calculatoare, Pb. 10",
    imagine: "",
  },
  {
    id: 214,
    ...
    subcategorie: "Rețele de calculatoare",
    enunt:
      "Cum se comportă un switch când primește un cadru pe o anumită interfață iar adresa destinație\nnu este cunoscută?",
    cod_sursa: "",
    variante: {
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Rețele de calculatoare, Pb. 11",
    imagine: "",
  },
  {
    id: 215,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Rețele de calculatoare, Pb. 12",
    imagine: "",
  },
  {
    id: 216,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Rețele de calculatoare, Pb. 13",
    imagine: "",
  },
  {
    id: 217,
    ...
    subcategorie: "Rețele de calculatoare",
    enunt:
      "Presupunând ca distanța dintre Timișoara și Arad este de 47 de kilometrii și avem o rată de\ntransfer de 500Mbps, latența transmiterii unui mesaj de 1MB este de:",
    cod_sursa: "",
    variante: {
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Rețele de calculatoare, Pb. 14",
    imagine: "",
  },
  {
    id: 218,
    ...
    subcategorie: "Rețele de calculatoare",
    enunt:
      "Doriți să folosiți full-duplex Ethernet în locul half-duplex. Care sunt avantajele pentru rețea?",
    cod_sursa: "",
    variante: {
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Rețele de calculatoare, Pb. 15",
    imagine: "",
  },
  {
    id: 219,
    ...
    subcategorie: "Rețele de calculatoare",
    enunt:
      "Calculați BDP pentru o conexiune cu următoarele repere: R=1Gbps, Distanta=100km",
    cod_sursa: "",
    variante: {
      a: "10∗2 2M b",
      b: "50MB",
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Rețele de calculatoare, Pb. 16",
    imagine: "",
  },
  {
    id: 220,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Rețele de calculatoare, Pb. 17",
    imagine: "",
  },
  {
    id: 221,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Rețele de calculatoare, Pb. 18",
    imagine: "",
  },
  {
    id: 222,
    ...
    subcategorie: "Rețele de calculatoare",
    enunt:
      "Calculați BDP pentru o conexiune cu următoarele repere: R=500Mbps, Distanța=100km",
    cod_sursa: "",
    variante: {
      a: "250Kb",
      b: "10∗2 2M b",
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Rețele de calculatoare, Pb. 19",
    imagine: "",
  },
  {
    id: 223,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Rețele de calculatoare, Pb. 20",
    imagine: "",
  },
  {
    id: 224,
    ...
    subcategorie: "Rețele de calculatoare",
    enunt:
      "Care este topologia rețelei unde fiecare nod este legat de cele mai apropiate două noduri în așa\nfel ca toată rețeaua să formeze un cerc?",
    cod_sursa: "",
    variante: {
      a: "magistrala;",
      b: "inel;",
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Rețele de calculatoare, Pb. 21",
    imagine: "",
  },
  {
    id: 225,
    ...
    explicatie: "",
    referinta_sursa:
      "Tematica 3: Sisteme de calcul - Rețele de calculatoare, Pb. 22",
    imagine: "",
  },
];
...
async function initQuiz() {
  ...
  try {
    ...
    console.warn(
      "Se folosește setul local de întrebări (fallback):",
      error.message,
    );
  ...
  if (selectedCategory === "all") {
    ...
    const mistakes = JSON.parse(
      localStorage.getItem("uvtQuizMistakes") || "[]",
    );
...
function validateAnswer() {
  ...
  if (isCorrect) {
    ...
    let correctSet = new Set(
      JSON.parse(localStorage.getItem("uvtCorrectQuestions") || "[]"),
    );
    correctSet.add(currentQuestion.id);
    localStorage.setItem(
      "uvtCorrectQuestions",
      JSON.stringify(Array.from(correctSet)),
    );
  ...
  explanationTextContent.textContent =
    currentQuestion.explicatie || "Nu există explicație disponibilă.";
  referenceText.textContent =
    currentQuestion.referinta_sursa || "Referință nespecificată.";
...
function saveScore(cat, score, total, percentage) {
  ...
  let leaderboard =
    JSON.parse(localStorage.getItem("uvtQuizLeaderboard")) || [];
...
function filterStudyQuestions() {
  const searchText = document
    .getElementById("study-search-input")
    .value.toLowerCase();
...
function checkActiveSession() {
  ...
  if (
    ...
    resumeCategoryName.textContent =
      session.category === "all" ? "Toate" : session.category;
...
function discardLearningSession() {
  if (
    confirm(
      "Sigur vrei să ștergi progresul salvat la sesiunea de învățare anterioară?",
    )
  ) {
...
Variante de răspuns:
${Object.entries(currentQuestion.variante)
  .map(([k, v]) => `(${k}) ${v}`)
  .join("\n")}
...
Te rog să îmi explici într-un mod didactic, concis si scurt de ce răspunsul corect este cel din barem, cum se execută codul (dacă este cazul) și de ce opțiunile selectate de mine sunt greșite (dacă am greșit). Răspunde direct în limba română, folosește formatare Markdown și păstrează tonul unui asistent universitar pasionat.
  ...
  try {
    ...
    if (!response.ok) {
      ...
      throw new Error(
        errData.error?.message || `Eroare HTTP ${response.status}`,
      );
    }
...
function formatAIText(text) {
  ...
  html = html.replace(
    /```([\s\S]*?)```/g,
    "<pre style='background: rgba(0, 0, 0, 0.2); padding: 10px; border-radius: 4px; font-family: monospace; overflow-x: auto; margin: 10px 0;'><code>$1</code></pre>",
  );
...
function renderStatsDashboard() {
  ...
  const correctIds = JSON.parse(
    localStorage.getItem("uvtCorrectQuestions") || "[]",
  );
